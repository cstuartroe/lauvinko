...
TESTS: list[tuple[LauvinkoMorpheme, str, str, ProtoKasanicOnset, ProtoKasanicMutation]] = [
    ...
    (lm('socya\\ng+N'), 'sot͡s.jâŋ', 'sʊtt͡ɕɐ̂ŋ', ProtoKasanicOnset.S, ProtoKasanicMutation.NASALIZATION),
    (lm('voh'), 'ʋok', 'ʋʊʔ', ProtoKasanicOnset.W, None),
    (lm('lahma'), 'lak.ma', 'lɐɦmɐ', ProtoKasanicOnset.R, None),
    (lm('allo/'), 'al.ló', 'ɐɭɭóː', None, None),
    (lm('arna'), 'al.na', 'ɐɳɳɐ', None, None),
    (lm('apsa'), 'ap.sa', 'ɐssɐ', None, None),
    (lm('acca'), 'at͡s.t͡sa', 'ɐst͡sɐ', None, None),
    (lm('apca'), 'ap.t͡sa', 'ɐtt͡sɐ', None, None),
