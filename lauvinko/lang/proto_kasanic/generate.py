...
CONSONANT_WEIGHTS = {
    ...
    ProtoKasanicOnset.NY: 27,
    ProtoKasanicOnset.NG: 31,
    ProtoKasanicOnset.NGW: 10,

    ProtoKasanicOnset.P: 21,
    ...
    ProtoKasanicOnset.NT: 24,
    ProtoKasanicOnset.NC: 7,
    ProtoKasanicOnset.NK: 14,
    ProtoKasanicOnset.NKW: 4,

    ProtoKasanicOnset.PP: 6,
    ProtoKasanicOnset.TT: 12,
    ProtoKasanicOnset.CC: 8,
    ProtoKasanicOnset.KK: 18,
    ProtoKasanicOnset.KKW: 5,

    ProtoKasanicOnset.S: 68,
    ProtoKasanicOnset.H: 16,
...
def random_pk_lemma(category: KasanicStemCategory) -> ProtoKasanicLemma:
    ...
    lemma.generic_morph.lemma = lemma
