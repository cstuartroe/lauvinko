...
class PKGenerationTests(unittest.TestCase):
    def test_generation(self):
        for _ in range(10):
            ...
            #     lv_transcribe(lv_lemma.form(PrimaryTenseAspect.GENERAL, augment=True).surface_form()),
            #     lv_transcribe(lv_lemma.form(PrimaryTenseAspect.GENERAL, augment=False).surface_form()),
            # )
